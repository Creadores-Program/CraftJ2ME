...
public class BreakBlockPacket implements CraftJ2MEPacketTranslator{
    @Override
    public void translate(JSONObject pk, Player player){
        ...
        if(player.getStartGamePacketCache().getAuthoritativeMovementMode() == AuthoritativeMovementMode.CLIENT){
            ...
            subpk.setAction(org.cloudburstmc.protocol.bedrock.packet.InteractPacket.Action.DAMAGE);
